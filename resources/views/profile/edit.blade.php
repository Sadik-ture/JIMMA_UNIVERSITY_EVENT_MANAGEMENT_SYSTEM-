                    ...
                    <div class="row">
                        <div class="col-md-6 offset-md-4">
                            <form method="POST" action="{{ route('profile.destroy') }}">
                                ...
                                <div class="mb-3">
                                    <label for="delete_password" class="form-label">Delete Account</label>
                                    <input id="delete_password" type="password" class="form-control" 
                                        name="password" placeholder="Enter your password to confirm deletion" required>
                                </div>
